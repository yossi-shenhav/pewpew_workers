...
class ShodanScan(Scan):
    ...
    error_file = 'shodan_errors.txt'

    def __init__(self, target, scanid, email, id):
        super().__init__(target, scanid, email)
        self.id = id
    ...
    def getCommands(self):
        ...
        commands = []
        commands = [f'shodan host {self.target} | tee {self.directory}/shodan_results{self.id}.txt'] 
        return commands
